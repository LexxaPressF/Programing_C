...
struct Distance										//Объявление структуры
{
	...
	double inches;
	void ShowDist()									//Перенос функции по заданию 10
	{
		cout << feet << "\'-" << inches << "\"\n";
	}
};

Distance AddDist(Distance d1, Distance d2)			//Объявление функции возращающей результатом элемент структуры
{													//(складывает элементы структуры)
...
Distance InputDist()								//Объявление функции возращающей результатом элемент структуры 
{													//(позволяет вводить элементы структуры)
	Distance d;										//Объявление элемента структуры внутри функции
	cout << "\nВведите число футов: ";
	cin >> d.feet;
...
//void ShowDist(Distance d)							//Объявление функции возращающей результатом элемент структуры 
//{													//(выводит компоненты элемента на экран в заданном виде)
...
int main()
{
	...
	//ShowDist(d3);
	d1.ShowDist();
	d2.ShowDist();									//Внутреняя функция вывода значений
	d3.ShowDist();
}
